...
import taskmanager.demo.dto.CreateTaskDTO;
import taskmanager.demo.dto.ErrorResponseDTO;
import taskmanager.demo.dto.TaskResponseDTO;
import taskmanager.demo.dto.UpdateTaskDTO;
import taskmanager.demo.entities.TaskEntity;
import taskmanager.demo.services.NotesService;
import taskmanager.demo.services.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<TaskResponseDTO> getTaskById( @PathVariable Integer id){
        ...
        var notes = notesService.getNodesForTask(id);
        if (task==null){
